...
SECRET_KEY = "django-insecure-f$jlpb$w9fikjk885q#-_!jlwera^)yq*hq-+pj6rc@4%6*8ka"
...
DATABASES = {
    'default': dj_database_url.parse(
        'postgresql://ecommerce_b00u_user:v8sb9k6bZzNXZMXquXJKzo5RiuyG5jFz@dpg-d21ahb2dbo4c73duv7o0-a.oregon-postgres.render.com/ecommerce_b00u',
        conn_max_age=600,
        ssl_require=True
    )
}
